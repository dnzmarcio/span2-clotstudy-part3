---
title: "SPAN 2 Clot Study - Day 2 Volume Fraction Lesion of the Right Hemisphere"
...
```{r}
source("00_utils.R") 
load("results/span2_clotstudy_p3_mri_d2_volume_lesion_right_analysis_pp.Rdata")
```
