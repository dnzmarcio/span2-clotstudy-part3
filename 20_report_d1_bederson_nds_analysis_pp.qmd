---
title: "SPAN 2 Clot Study - Bederson Neurodeficit score at Day 1"
...
```{r}
source("00_utils.R") 
load("results/span2_clotstudy_p3_bederson_nds_d1_analysis_pp.Rdata")
```
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - Bederson Neurodeficit at Day 1 - Feasibility"
  ) 
```
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - Bederson Neurodeficit at Day 1 - Feasibility by site"
  ) 
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - Bederson Neurodeficit at Day 1 - Feasibility by sex"
  ) 
```
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - Bederson Neurodeficit at Day 1 - Feasibility by treatment"
  ) 
```
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - Bederson Neurodeficit at Day 1 - Feasibility by clot length"
  ) 
```
:::
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - Bederson Neurodeficit at Day 1"
  ) 
```
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - Bederson Neurodeficit at Day 1 by treatment"
  ) 
```
