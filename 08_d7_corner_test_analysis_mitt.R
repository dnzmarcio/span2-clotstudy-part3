...
ylabel <- "Alternative Corner Test Index at Day 7"
...
dm <- dt |>
  select(alternative_corner_index_d7, alternative_corner_index_d0, 
...
fit <- pim(alternative_corner_index_d7 ~ alternative_corner_index_d0 + site + 
...
dm_imputed <- dt |> 
  mutate(alternative_corner_index_d7 = 
           ifelse(corner_d7_conduct == "Yes", alternative_corner_index_d7,
                  ifelse(corner_d7_conduct_rsn == "Animal death", 
                         max(alternative_corner_index_d7, na.rm = TRUE),
                         NA)))|> 
  droplevels() |> 
  select(alternative_corner_index_d7,alternative_corner_index_d0,
...
fit <- with(dt_imputed, pim(alternative_corner_index_d7 ~ alternative_corner_index_d0 + site + 
...
fit <- with(dt_imputed_cl3, pim(alternative_corner_index_d7 ~ alternative_corner_index_d0 + site + 
...
fit <- with(dt_imputed_cl4, pim(alternative_corner_index_d7 ~ alternative_corner_index_d0 + site + 
                                  enro_sex + txas_reperfusion))
...
rm(list=setdiff(ls(), c("file", 
                        ...
                        "plots",
                        "pim_results")))
save.image("results/span2_clotstudy_p3_d7_corner_test_analysis_mitt.Rdata")
