---
title: "SPAN 2 Clot Study - Bederson Neurodeficit score at Day 30"
...
```{r}
source("00_utils.R") 
load("results/span2_clotstudy_p3_bederson_nds_d30_analysis_pp.Rdata")
```
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - Bederson Neurodeficit at Day 30 - Feasibility"
  ) 
```
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - Bederson Neurodeficit at Day 30 - Feasibility by site"
  ) 
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - Bederson Neurodeficit at Day 30 - Feasibility by sex"
  ) 
```
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - Bederson Neurodeficit at Day 30 - Feasibility by treatment"
  ) 
```
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - Bederson Neurodeficit at Day 30 - Feasibility by clot length"
  ) 
```
:::
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - Bederson Neurodeficit at Day 30"
  ) 
```
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - Bederson Neurodeficit at Day 30 by treatment"
  ) 
```
...
```{r}
tab <- tables$pim$noimputation$overall$txas_reperfusion 
gt(tab) |> 
  tab_header(
...
```{r}
tab <- tables$pim$imputation_ws_overall$overall$txas_reperfusion 
gt(tab) |> 
  tab_header(
    title = "Relative Effect - Probabilistic Index Model"
  ) |>
...
```{r}
tab <- tables$pim$imputation_ws_cls$overall$txas_reperfusion 
gt(tab) |> 
  tab_header(
    title = "Relative Effect - Probabilistic Index Model"
  ) |>
...
```{r}
tab <- tables$pim$imputation_ws_clst$overall$txas_reperfusion 
gt(tab) |> 
  tab_header(
    title = "Relative Effect - Probabilistic Index Model"
  ) |>
...
```{r}
tab <- tables$pim$imputation_mi$overall$txas_reperfusion 
gt(tab) |> 
  tab_header(
    title = "Relative Effect - Probabilistic Index Model"
  ) |>
