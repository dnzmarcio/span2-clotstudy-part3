---
title: "SPAN 2 Clot Study - Simple SPAN Score"
subtitle: "mITT"
...
```{r}
source("00_utils.R") 
load("results/span2_clotstudy_p3_simple_span_score_d30_analysis_mitt.Rdata")
```
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - SPAN Simple Score - Feasibility"
  ) 
```
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - SPAN Simple Score - Feasibility by site"
  ) 
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - SPAN Simple Score - Feasibility by sex"
  ) 
```
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - SPAN Simple Score - Feasibility by cloth length"
  ) 
```
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - SPAN Simple Score - Feasibility by treatment"
  ) 
```
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - SPAN Simple Score"
  ) 
```
...
nt_format(tab) |>
  tab_header(
    title = "Descriptive Analysis - SPAN Simple Score by treatment"
  ) 
```
